...
class AboutUsPageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $content = [
            ...
            'free_title_1' => '<p><strong><span style="color: rgb(0, 117, 255);">Nuestra Mision</span></strong></p>',
            ...
            'free_title_2'=>'<p><strong><span style="color: rgb(0, 117, 255);">Nuestra Vision</span></strong></p>',
