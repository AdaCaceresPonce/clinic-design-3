...
class OurProfessionalsPageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $content = [
            ...
            'cover_img' => 'web_pages_images/our_professionals_page/' . $faker->image('public/storage/web_pages_images/our_professionals_page', 1200, 800, null, false),
            ...
            'our_professionals_img'=> 'web_pages_images/our_professionals_page/' . $faker->image('public/storage/web_pages_images/our_professionals_page', 1200, 800, null, false),
