    ...
    public function run(): void
    {
        ...
        $professionals = [
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/pedro_martinez.jpeg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/maria_isabel.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/juan_carlos.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/isabel_cristina.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/carolina_sofia.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/jorge_luis.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/sofia_elena.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/andres_felipe.jpg',
                ],
            ...
            [
                ...
                'images' => [
                    'photo_path' => 'professionals/elena_teresa.jpg',
                ],
        ...
        foreach ($professionals as $professional) {
            ...
            unset($professional['specialties']);

            //Añadir foto de prueba
            // $professional['photo_path'] = 'professionals/' . $faker->image('public/storage/professionals', 640, 480, null, false);


            //Almacenar imagenes
            $imagesData = [];

            foreach ($professional['images'] as $field => $filePath) {
                if ($filePath) {
                    $source = public_path("base_images/{$filePath}");
                    if (File::exists($source)) {
                        $destPath = "{$filePath}";
                        Storage::disk('public')->put($destPath, File::get($source));
                        $imagesData[$field] = $destPath;
                    } else {
                        $imagesData[$field] = 'professionals/null.jpg';
                    }
                } else {
                    $imagesData[$field] = 'professionals/null.jpg';
                }
            ...
            foreach ($professionalSpecialties as $specialtyName) {
                ...
                $professionalCreated->specialties()->attach($specialty);
            }
        }
    }
}
