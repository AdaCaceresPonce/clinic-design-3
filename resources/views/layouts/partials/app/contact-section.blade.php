...
<section id="contact" class="py-16 bg-white">
    <x-container class="px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {{-- Dirección --}}
            <div class="bg-white shadow-[0_4px_6px_#C8F8FF] rounded-xl shadow-md p-6 text-center flex flex-col items-center  transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            ...
            {{-- Teléfono --}}
            <div class="bg-gradient-to-r from-blue-600 to-teal-500 rounded-xl shadow-md p-6 text-center flex flex-col items-center text-white hover:shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            ...
            {{-- Email --}}
            <div class="bg-white rounded-xl shadow-md p-6 text-center flex flex-col items-center hover:shadow-lg shadow-[0_4px_6px_#C8F8FF] transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                <div class="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-teal-400 mb-3 text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {{-- Horarios --}}
            <div class="bg-gradient-to-r from-blue-600 to-teal-500 rounded-xl shadow-md p-6 text-center flex flex-col items-center text-white transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                <div class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-blue-600 mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
