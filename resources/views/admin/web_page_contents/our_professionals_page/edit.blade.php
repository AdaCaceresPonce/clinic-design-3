...
<x-admin-layout :breadcrumbs="[
    ...
    <x-slot name="action">
        <x-wireui-button href="{{ route('admin.our_professionals_page_content.index') }}" blue>
    ...
    <div class="max-w-[1230px] mx-auto">
        ...
        <form action="{{ route('admin.our_professionals_page_content.update') }}" method="POST"
            ...
            <div class="space-y-6"">
                ...
                <x-admin.web_page_contents.page-section-card id="cover" :section_title="'Portada'" :description="'Primera sección con imagen de fondo'"
                    :route_name="'our_professionals.index'" :section_id="'#cover'">
                    {{-- Columnas --}}
                ...
                {{-- Seccion Nuestros Profesionales --}}
                <x-admin.web_page_contents.page-section-card id="professionals" :section_title="'Nuestros Profesionales'" :description="'Información general acerca de los profesionales'"
                    :route_name="'our_professionals.index'" :section_id="'#professionals'">
                    {{-- Columnas --}}
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 xl:gap-6">
                        <div class="space-y-4">
                ...
                {{-- Seccion de Listado de Profesionales --}}
                <x-admin.web_page_contents.page-section-card id="professionals_team" :section_title="'Listado de Profesionales'" :description="'Títulos de la sección donde se listan los Profesionales'"
                    :route_name="'our_professionals.index'" :section_id="'#professionals_team'">
                    {{-- Columnas --}}
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 xl:gap-6">
                        <div>
                            ...
                            <div>
                                <div class="text__editor" data-textarea="our_professionals_team_title">
                                    {!! old('our_professionals_team_title', $contents->our_professionals_team_title) !!}
                                </div>
                                <textarea class="hidden" name="our_professionals_team_title" id="our_professionals_team_title">{!! old('our_professionals_team_title', $contents->our_professionals_team_title) !!}</textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div>
                                <div class="text__editor" data-textarea="our_professionals_team_description">
                                    {!! old('our_professionals_team_description', $contents->our_professionals_team_description) !!}</div>
                                <textarea class="hidden" name="our_professionals_team_description" id="our_professionals_team_description">{!! old('our_professionals_team_description', $contents->our_professionals_team_description) !!}</textarea>
                            </div>
