        ...
        <div class="card-gray mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                <div class="col lg:mb-0">
                    ...
                    <x-label class="mb-2 text-[15px] font-black">Logo para el navbar</x-label>
                    <figure class="relative">
                        ...
                        <img id="uploadPreview1"
                            class="object-contain w-full aspect-[4/3] border-[2px] bg-white border-blue-400 rounded-xl @error('navbar_clinic_logo') border-red-500 @enderror"
                            src="{{ Storage::url($clinic_information->navbar_clinic_logo) }}" alt="">
                    </figure>
                    <x-input-error for="navbar_clinic_logo" />
                </div>
                <div class="col">
                    <x-label class="mb-2 text-[15px] font-black">Logo para el footer</x-label>
                    <figure class="relative">
                        <div class="absolute top-4 right-4">
                            <label
                                class="flex items-center px-2.5 py-1.5 lg:px-4 lg:py-2 rounded-lg btn-blue cursor-pointer text-sm lg:text-base">
                        ...
                        <img id="uploadPreview2"
                            class="object-contain w-full aspect-[4/3] border-[2px] bg-white border-blue-400 rounded-xl @error('footer_clinic_logo') border-red-500 @enderror"
                            src="{{ Storage::url($clinic_information->footer_clinic_logo) }}" alt="">
                    </figure>
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <x-input class="w-full" placeholder="Ingrese el horario de atencion de la clínica" name="schedule"
                ...
                <div class="mb-4">
                    <x-label class="mb-1 text-[15px] font-black">Dirección</x-label>
                    <x-input class="w-full" placeholder="Ingrese el correo electrónico de la clínica" name="address"
